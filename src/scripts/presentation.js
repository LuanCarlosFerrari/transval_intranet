...
export const aboutContent = {
    _eventsData: [ // Store event data centrally
        ...
        { year: "2005", title: "Expansão da Frota própria", details: "Consolidação de frota própria, garantindo agilidade, controle e segurança.", bgColor: "bg-white", textColor: "text-blue-950", yearColor: "text-blue-600", dotColor: "bg-blue-600", contentAbove: true, detailsColor: "text-blue-950", icon: "fas fa-map-marker-alt", iconColor: "text-blue-950" },
